...
class fetchmail_server(models.Model):
    ...
    def onchange_server_type(self):
        super(fetchmail_server, self).onchange_server_type()
        self.state = 'draft'
    ...
    def fetch_mail(self):
        ...
        for this in self:
            ...
            # context['fetchmail_server_id'] = this.id
            # context['server_type'] = this.type
    ...
    def fields_view_get(self, view_id=None, view_type='form',
        ...
        if view_type == 'form':
            ...
            modifiers = {}
            docstr = ''
            for algorithm in self.env['fetchmail.server.folder']\
